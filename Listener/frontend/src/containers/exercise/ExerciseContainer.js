...
const ExerciseContainer = () => {
  ...
  return (
    <>
    <Ec>
    {first && <div><First setSquatCount={setSquatCount} setLungeCount={setLungeCount} setShoulderCount={setShoulderCount}/>
      <Spacer/><StyledButton onClick={videoOn}>시작</StyledButton></div>}
      {showResults && 
      <Wrapper>
        <Spacer/>
        <div id="watch">
